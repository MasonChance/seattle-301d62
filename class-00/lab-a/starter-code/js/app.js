'use strict';
//FIXME: per Nicholas instruction, ONly required to change 2 instances of concatenation to template literal rather than all. 
...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT  rando was declared with const, restricting it's scope only to the code block in the displayPics(function). by logging it outside of the code block the interpreter has no access to it. 
  console.log(viewed);
